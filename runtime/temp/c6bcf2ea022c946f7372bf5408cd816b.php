<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpstudy_pro\WWW\public/../application/admin\view\login\index.html";i:1585394232;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
        ...
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="password" class="input input-big" name="admin_pass" placeholder="登录密码" data-validate="required:请填写密码" />
