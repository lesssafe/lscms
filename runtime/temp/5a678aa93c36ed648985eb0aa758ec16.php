<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpstudy_pro\WWW\public/../application/admin\view\index\articleadd.html";i:1585623486;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="articleadd">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="writer" value="admin"  />
          <div class="tips"></div>
        </div>
      </div>
